...
<div class="span11">
  <form id="tipoPaginaForm" name="tipoPaginaForm" method="post" action="../controller/controllerEditarPaginaCap.php" onsubmit="javascript:return validar()">
  <fieldset>
  ...
  <div class="control-group">
    ...
    <div class="controls">             
      ...
      <textarea name="txtaccion" id="txtaccion" class="span12" rows="2"><?php echo $pagina["accion"]; ?></textarea>   
    </div>
    <div class="controls">             
    ...
    <div class="clearfix">&nbsp;</div>
     <div class="controls">             
      <label>Cambiar estilo formulario:</label>
      <select name="selestiloform" id="selestiloform" class="span3">
