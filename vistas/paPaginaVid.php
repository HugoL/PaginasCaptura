...
<div class="row-fluid">
	...
	<div class="span11">
	    <h2>Crear página de ventas</h2>	    
	</div>
<div class="span11">
  <form id="tipoPaginaForm" name="tipoPaginaForm" method="post" action="../controller/controllerInsertarPaginaVid.php" onsubmit="javascript:return validar()">
  <fieldset>
    <input type="hidden" id="hdidusuario" name="hdidusuario" value="<?php echo $current_user->ID; ?>"/>
    <input type="hidden" id="hdidtipopagina" name="hdidtipopagina" value="<?php echo $idTipoPagina; ?>"/>
  ...
  <div class="control-group">
    ...
    <div class="controls">             
      ...
      <input type="text" name="txturlbotoncompra" id="txturlbotoncompra" class="tags span12" placeholder="pega aquí la dirección"/>  
    </div>
    <div class="clearfix">&nbsp;</div>    
    <div class="controls">             
